 ...
 */
public class WelcomeInputFragment extends Fragment implements Button.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = null;
        view = inflater.inflate(R.layout.fragment_welcome_input, container, false);
        ...
        gameTitle=(TextView) view.findViewById(R.id.title_game);
