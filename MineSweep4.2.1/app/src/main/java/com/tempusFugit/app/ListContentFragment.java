...
public class ListContentFragment extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private final String[] mMemberEmails;
        private final Drawable[] mMemberAvators;
        public ContentAdapter(Context context) {
            Resources resources = context.getResources();
            mMembers = resources.getStringArray(R.array.member_names);
            mMemberEmails = resources.getStringArray(R.array.member_emails);
            TypedArray a = resources.obtainTypedArray(R.array.member_picture);
